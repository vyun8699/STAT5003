...
+ The goal of this exercise is to define 'bad debtors' based on their credit history and identify if a pattern or signal exists amongst applicants. 
+ Management of bad debt is a key value driver in banking / the credit industry. Insights from this analysis may assist banks in acquiring the right customers and decide on their credit risk management strategy to minimize loss. Analyzing applicant profiles is a first step in understanding credit card customer's default behaviour [(Li et. al, 2019)](https://www.kaggle.com/datasets/rikdifos/credit-card-approval-prediction).
+ The dataset can be found [here](https://www.kaggle.com/datasets/rikdifos/credit-card-approval-prediction).
