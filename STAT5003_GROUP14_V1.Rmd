...
LogRes.results.balanced.accuracy = (LogRes.results.recall + LogRes.results.specificity)/2
...
overall.results.df['recall','LogRes'] <- LogRes.results.recall
...
overall.results.df['balanced.accuracy','LDA'] <- mean(diag(test_conf_mat$table))
overall.results.df['recall','LDA'] <- test_recall
overall.results.df['precision','LDA'] <- test_precision
overall.results.df['specificity','LDA'] <- test_conf_mat$byClass['Specificity']
overall.results.df['f1.score','LDA'] <- test_f1

print(paste("Overall results with test dataset: ", overall.results.df))
```
