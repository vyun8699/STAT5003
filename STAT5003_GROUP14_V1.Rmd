...
cat("Accuracy:",lda.train.accuracy , "\n")
cat("Sensitivity:",lda.train.sensitivity , "\n")
cat("Precision:",lda.train.precision, "\n")
cat("Specificity:",lda.train.specificity, "\n")
cat("Balanced Accuracy:",lda.train.balanced.accuracy, "\n")
cat("F1 Score:",lda.train.f1.score , "\n")
